...
install.packages("https://cloud.r-project.org/src/contrib/remotes_2.4.2.tar.gz", repo = NULL) # https://cloud.r-project.org/web/packages/remotes/index.html
library(remotes)
core_tidyverse <- list( # https://tidyverse.tidyverse.org/index.html
    c("tidyverse", "1.3.1"), # https://cloud.r-project.org/web/packages/tidyverse/index.html
    c("ggplot2", "3.3.6"), # https://cloud.r-project.org/web/packages/ggplot2/index.html
    c("dplyr", "1.0.9"), # https://cloud.r-project.org/web/packages/dplyr/index.html
    c("tidyr", "1.2.0"), # https://cloud.r-project.org/web/packages/tidyr/index.html
    c("readr", "2.1.2"), # https://cloud.r-project.org/web/packages/readr/index.html
    c("purrr", "0.3.4"), # https://cloud.r-project.org/web/packages/purrr/index.html
    c("tibble", "3.1.7"), # https://cloud.r-project.org/web/packages/tibble/index.html
    c("stringr", "1.4.0"), # https://cloud.r-project.org/web/packages/stringr/index.html
    c("forcats", "0.5.1") # https://cloud.r-project.org/web/packages/forcats/index.html
)
...
other_packages <- list(
    c("markdown", "1.1"), # https://cloud.r-project.org/web/packages/markdown/index.html
    c("corrr", "0.4.3"), # https://cloud.r-project.org/web/packages/corrr/index.html
    c("DBI", "1.1.2"), # https://cloud.r-project.org/web/packages/DBI/index.html
    c("discrim", "0.2.0"), # https://cloud.r-project.org/web/packages/discrim/index.html
